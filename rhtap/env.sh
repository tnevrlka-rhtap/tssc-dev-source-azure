...
export IMAGE_URL=${IMAGE_URL-quay.io/tnevrlka-rhtap/bootstrap:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/tnevrlka-rhtap/tssc-dev-gitops-azure
...
export TUF_MIRROR=
# Update forced CI test Wed Mar 19 15:57:02 CET 2025
